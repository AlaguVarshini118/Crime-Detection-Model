...
# Model paths
modelConfiguration = r"C:\images'\New folder\pistol files\yolov3-custom.cfg"
modelWeights = r"C:\images'\New folder\pistol files\yolov3-custom_2000.weights"
        ...
        for detection in output:
            ...
            if confidence >= confThreshold and classNames[classIndex] == "Pistol":
                if not pistol_detected:  # Print message only if pistol has not been detected before
                    ...
                    threading.Thread(target=playsound, args=(r"C:\Users\Vachu jothi\OneDrive\Desktop\sound\emergency-alarm-with-reverb-29431.mp3",)).start()
